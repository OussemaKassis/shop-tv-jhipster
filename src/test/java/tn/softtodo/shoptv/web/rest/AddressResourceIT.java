...
import tn.softtodo.shoptv.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    private static final Instant DEFAULT_ZIP_CODE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_ZIP_CODE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().country(DEFAULT_COUNTRY).city(DEFAULT_CITY).zipCode(DEFAULT_ZIP_CODE);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().country(UPDATED_COUNTRY).city(UPDATED_CITY).zipCode(UPDATED_ZIP_CODE);
        return address;
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.country(UPDATED_COUNTRY).city(UPDATED_CITY).zipCode(UPDATED_ZIP_CODE);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.city(UPDATED_CITY).zipCode(UPDATED_ZIP_CODE);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.country(UPDATED_COUNTRY).city(UPDATED_CITY).zipCode(UPDATED_ZIP_CODE);
