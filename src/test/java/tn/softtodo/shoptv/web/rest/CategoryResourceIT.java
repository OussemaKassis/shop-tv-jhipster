...
import tn.softtodo.shoptv.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().categoryName(DEFAULT_CATEGORY_NAME).ratio(DEFAULT_RATIO);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().categoryName(UPDATED_CATEGORY_NAME).ratio(UPDATED_RATIO);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getRatio()).isEqualTo(DEFAULT_RATIO);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.categoryName(UPDATED_CATEGORY_NAME).ratio(UPDATED_RATIO);
        ...
        assertThat(testCategory.getRatio()).isEqualTo(UPDATED_RATIO);
    }
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.categoryName(UPDATED_CATEGORY_NAME).ratio(UPDATED_RATIO);
