      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            videoDuration: expect.any(Object),
            videoSize: expect.any(Object),
            videoCategory: expect.any(Object),
            videoRating: expect.any(Object),
            videoStatus: expect.any(Object),
            videoPublicUrl: expect.any(Object),
            videoPath: expect.any(Object),
            videoVisibleFor: expect.any(Object),
            afterEffectsTemplate: expect.any(Object),
