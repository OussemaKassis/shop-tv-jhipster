...
describe('PurchaseHistory Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'purchase-history', component: PurchaseHistoryComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to purchaseHistoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPurchaseHistoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPurchaseHistoryIdentifier).toHaveBeenCalledWith(entity);
